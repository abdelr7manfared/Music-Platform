...
'A = Album(name="LOL!",release_date=datetime.datetime(2007,11,19),cost=15.19,artist=artist)'
### second way 
...
'for art in Artist.objects.all():
         print(art,Album.objects.filter(artist=art.id))
'
...
'
### second way
'for Alb in Album.objects.select_related('artist'):
